...
$targetResourceGroup = "K8S_WEU_DEV_3.0_1"
$targetVirtualNetworkName = "aks-mgt-k8s-dev"
$targetSubnetName = "aks-mgt-k8s-dev-middleware"
...
#####################################################################################
Write-Output -InputObject "Connect to virtual network resources"

# Get a subnet configuration
$subnetId = (Get-AzVirtualNetwork -Name $targetVirtualNetworkName -ResourceGroupName $targetResourceGroup | Get-AzVirtualNetworkSubnetConfig -Name $targetSubnetName).Id
